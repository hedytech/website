      ...
      <div className='fadeinclass'>
        ...
        for continuous learning.
            ...
            <div className='justifycenter'>
              ...
              one of the top languages within a couple of years.
                  </h4>
                  <h4>
              ...
              the biggest code base available as well. In fact, one of the purposes of Kotlin was to build a better Java.
                  </h4>
                </div>
                <div className='academytextthin2'>
                  <h4>
              So you have a modern language that is easy to learn, concise, expressive, statically typed,
              minimal boilerplate that soon also will be multiplatform (experimental so far).
                  </h4>
                  <h4>
              ...
              So you know you will have solid tools that are up to date with all features, be it experimental or stable.
                  </h4>
                </div>
              </div>
              ...
              <div className='academyteambox'>
                ...
                it won’t describe what an if-statement, lambda or immutables are more than briefly.
                  </h4>
                </div>
                <div className='academytextthin2'>
                  <h4>PREREQUISITES</h4>
